    ...
    private static readonly IReadOnlyDictionary<string, IReadOnlyDictionary<string, string>> Resources =
        new Dictionary<string, IReadOnlyDictionary<string, string>>(StringComparer.OrdinalIgnoreCase)
        {
            ["en"] = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
            {
                ...
                ["ClearCurrentMessage"] = "Delete Current",
                ["ClearSelectedMessages"] = "Delete Checked",
                ...
                ["CheckedMessagesLabel"] = "Checked Messages: {0}",
                ["Host"] = "Host",
                ["Port"] = "Port",
                ...
                ["Payload"] = "Payload",
                ["Cancel"] = "Cancel",
                ["PublishDialogTitle"] = "Publish Message",
                ["PublishHint"] = "Publish sends the payload to the current broker connection using the topic and flags below.",
                ["PublishQos0"] = "QoS 0",
                ["PublishQos1"] = "QoS 1",
                ["PublishQos2"] = "QoS 2",
                ...
                ["StatusImportedCountMulti"] = "Imported {0} message(s) from {1} files.",
                ["StatusImportedCountWithErrors"] = "Imported {0} message(s) from {1} file(s). Failed: {2}",
                ["ImportedMultipleFiles"] = "{0} files",
                ["StatusImportedRange"] = "Imported {0} of {1} message(s) within the selected range.",
                ["ImportRangeTitle"] = "Select time range",
                ["ImportRangeDescription"] = "Only messages received within this range will be imported.",
                ["ImportRangeStart"] = "Start",
                ["ImportRangeEnd"] = "End",
                ["ImportRangeAvailable"] = "Available: {0} – {1}  ({2} messages)",
                ["ImportRangeFull"] = "Full range",
                ["ImportRangeOk"] = "Import",
                ["ImportRangeCancel"] = "Cancel",
                ["ImportRangeInvalid"] = "Enter a valid date/time (yyyy-MM-dd HH:mm:ss). End must be after start.",
                ...
                ["StatusTrimmedOldest"] = "Trimmed {0} oldest message(s) (archived).",
                ["StatusArchiveFailed"] = "Archive write failed: {0}",
                ["ArchiveTrimmedLabel"] = "Archive trimmed",
                ["ArchiveTrimmedTooltip"] = "When the message count exceeds the cap, archive the oldest messages to a .jsonl file before removing them.",
                ["MaxMessagesLabel"] = "Max kept",
                ["MaxMessagesTooltip"] = "Maximum number of messages kept in memory. Oldest messages beyond this are trimmed (and archived if enabled).",
                ["ApplyMaxMessages"] = "Apply",
                ["ConfirmTrimTitle"] = "Apply message cap",
                ["ConfirmTrimMessage"] = "Setting the cap to {0} will remove the {1} oldest message(s) now. {2}\n\nContinue?",
                ["ConfirmTrimArchivedNote"] = "They will be archived to the log folder first.",
                ["ConfirmTrimDiscardedNote"] = "They will be discarded (archiving is off).",
                ["StatusMaxMessagesSet"] = "Message cap set to {0}.",
                ["StatusMaxMessagesCanceled"] = "Cap change canceled.",
                ...
                ["StatusClearedSelectedMessages"] = "Cleared {0} selected message(s).",
                ...
                ["StatusPublishTopicRequired"] = "Publish topic is required.",
                ["StatusPublished"] = "Published message to '{0}'.",
                ["StatusPublishFailed"] = "Publish failed: {0}",
                ...
                ["ExportSelectedMessage"] = "Single Message",
                ["ExportSelectedMessages"] = "Checked Messages",
            ...
            ["ko"] = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
            {
                ...
                ["ClearMessage"] = "메시지 삭제",
                ["ClearCurrentMessage"] = "현재 메시지 삭제",
                ["ClearSelectedMessages"] = "체크한 메시지 삭제",
                ["ReceivedAt"] = "수신 시각",
                ["Size"] = "크기",
                ["Retain"] = "Retain",
                ["Preview"] = "미리보기",
                ...
                ["CheckedMessagesLabel"] = "체크한 메시지: {0}",
                ["Host"] = "호스트",
                ["Port"] = "포트",
                ["TopicFilter"] = "토픽 필터",
                ...
                ["Payload"] = "Payload",
                ["Cancel"] = "취소",
                ["PublishDialogTitle"] = "메시지 Publish",
                ["PublishHint"] = "현재 연결된 브로커로 topic, QoS, retain 설정을 사용해 payload를 전송합니다.",
                ["PublishQos0"] = "QoS 0",
                ["PublishQos1"] = "QoS 1",
                ["PublishQos2"] = "QoS 2",
                ...
                ["StatusImportedCountMulti"] = "{1}개 파일에서 {0}개 메시지를 가져왔습니다.",
                ["StatusImportedCountWithErrors"] = "{1}개 파일에서 {0}개 메시지를 가져왔습니다. 실패: {2}",
                ["ImportedMultipleFiles"] = "파일 {0}개",
                ["StatusImportedRange"] = "선택한 범위에서 {1}건 중 {0}건을 가져왔습니다.",
                ["ImportRangeTitle"] = "시간 범위 선택",
                ["ImportRangeDescription"] = "이 범위에 수신된 메시지만 가져옵니다.",
                ["ImportRangeStart"] = "시작",
                ["ImportRangeEnd"] = "끝",
                ["ImportRangeAvailable"] = "전체 범위: {0} ~ {1}  ({2}건)",
                ["ImportRangeFull"] = "전체 범위",
                ["ImportRangeOk"] = "가져오기",
                ["ImportRangeCancel"] = "취소",
                ["ImportRangeInvalid"] = "올바른 날짜/시간을 입력하세요 (yyyy-MM-dd HH:mm:ss). 끝은 시작 이후여야 합니다.",
                ...
                ["StatusTrimmedOldest"] = "오래된 메시지 {0}건을 정리했습니다(보관됨).",
                ["StatusArchiveFailed"] = "보관 파일 기록 실패: {0}",
                ["ArchiveTrimmedLabel"] = "정리 메시지 보관",
                ["ArchiveTrimmedTooltip"] = "메시지 개수가 상한을 초과하면 오래된 메시지를 제거하기 전에 .jsonl 파일로 보관합니다.",
                ["MaxMessagesLabel"] = "최대 보관",
                ["MaxMessagesTooltip"] = "메모리에 보관하는 최대 메시지 수. 이를 넘는 오래된 메시지는 정리됩니다(보관 켜짐 시 파일로 저장).",
                ["ApplyMaxMessages"] = "적용",
                ["ConfirmTrimTitle"] = "메시지 상한 적용",
                ["ConfirmTrimMessage"] = "상한을 {0}(으)로 설정하면 지금 가장 오래된 {1}건이 제거됩니다. {2}\n\n계속할까요?",
                ["ConfirmTrimArchivedNote"] = "제거 전 log 폴더에 보관됩니다.",
                ["ConfirmTrimDiscardedNote"] = "보관이 꺼져 있어 그대로 삭제됩니다.",
                ["StatusMaxMessagesSet"] = "메시지 상한을 {0}(으)로 설정했습니다.",
                ["StatusMaxMessagesCanceled"] = "상한 변경을 취소했습니다.",
                ...
                ["StatusClearedSelectedMessages"] = "{0}개 선택 메시지를 삭제했습니다.",
                ...
                ["StatusPublishTopicRequired"] = "Publish topic은 필수입니다.",
                ["StatusPublished"] = "'{0}' 토픽으로 메시지를 전송했습니다.",
                ["StatusPublishFailed"] = "Publish 실패: {0}",
                ...
                ["ExportSelectedMessage"] = "단일 메시지",
                ["ExportSelectedMessages"] = "체크한 메시지",
